...
function seed() {
  ...
  const plaza = [
    ...
    { t: 'arbol', x: 6, y: L / 2, r: 0, c: 0 },
    { t: 'arbol', x: L - 6, y: L / 2, r: 0, c: 0 },
    { t: 'arbol', x: L / 2, y: L - 6, r: 0, c: 0 },
    { t: 'flores', x: L / 2 - 5, y: L / 2 + 6, r: 0, c: 1 },
    { t: 'flores', x: L / 2 + 5, y: L / 2 + 6, r: 0, c: 3 },
  ];
  // camino de la plaza hacia la casa de muestra (este)
  for (let x = L / 2 + 6; x < L; x += 4) plaza.push({ t: 'camino', x, y: L / 2 - 8, r: 0, c: 0 });

  const casa = [
    { t: 'casa', x: L / 2, y: L / 2 + 4, r: 0, c: 2 },
    { t: 'arbol', x: 8, y: L - 8, r: 0, c: 0 },
    { t: 'pino', x: L - 8, y: L - 8, r: 0, c: 0 },
    { t: 'pino', x: L - 8, y: 8, r: 0, c: 0 },
    { t: 'arbusto', x: L / 2 - 8, y: L / 2 - 2, r: 0, c: 0 },
    { t: 'arbusto', x: L / 2 + 8, y: L / 2 - 2, r: 0, c: 0 },
    { t: 'flores', x: L / 2 - 4, y: L / 2 - 3, r: 0, c: 3 },
    { t: 'flores', x: L / 2 + 4, y: L / 2 - 3, r: 0, c: 1 },
    { t: 'banco', x: L / 2 + 12, y: L / 2 + 2, r: 0, c: 0 },
